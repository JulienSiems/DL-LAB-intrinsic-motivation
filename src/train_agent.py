...
@click.command()
@click.option('-ne', '--num_episodes', default=0, type=click.INT, help='train for n episodes (0 to disable)')
@click.option('-nts', '--num_total_steps', default=21000000, type=click.INT, help='train for n steps total (0 to disable)')
@click.option('-ec', '--eval_cycle', default=0, type=click.INT, help='evaluate every n episodes (0 to disable)')
@click.option('-nee', '--num_eval_episodes', default=0, type=click.INT, help='each evaluation is over n episodes (0 to disable)')
@click.option('-sc', '--store_cycle', default=10, type=click.INT, help='save model every n episodes (0 to disable)')
...
@click.option('-lr', '--learning_rate', default=6.25e-5, type=click.FLOAT)
...
@click.option('-nsr', '--n_step_reward', default=5, type=click.INT)
@click.option('-mu', '--mu_intrinsic', default=0.0005, type=click.FLOAT)
@click.option('-beta', '--beta_intrinsic', default=0.4, type=click.FLOAT)
@click.option('-lambda', '--lambda_intrinsic', default=1.5, type=click.FLOAT)
...
@click.option('-uq', '--update_q_target', default=16000, type=click.INT,
...
@click.option('-per_a', '--prio_er_alpha', default=0.5, type=click.FLOAT)
...
@click.option('-per_bdc', '--prio_er_beta_decay', default=4000000, type=click.INT)
