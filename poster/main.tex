...
\title{Deep Learning Lab: Exploration with Intrinsic Motivation}
\author{Kirill Yankov\textsuperscript{$\dagger$} Rishan Senanayake\textsuperscript{$\dagger$}  Kilian\textsuperscript{$\dagger$} Julien Siems\textsuperscript{$\dagger$}}
\institute{\textsuperscript{$\dagger$}Department of Computer Science, Albert-Ludwigs-University Freiburg}

\titlegraphic{\includegraphics[width=0.05\textwidth]{uni_freiburg_logo.pdf}}
